...
- Use `MacBookPro16,2` [SMBIOS](https://github.com/corpnewt/GenSMBIOS).
- Speakers and headphone jack are broken on macOS 26, [reinstall AppleHDA](https://github.com/perez987/AppleHDA-back-on-macOS-26-Tahoe) to make audio work.
